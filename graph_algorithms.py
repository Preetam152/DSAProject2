...
def run_all():
    ...
    g1, source1 = read_graph_from_file("directed_graph.txt")
    ...
    g2, source2 = read_graph_from_file("undirected_graph.txt")
    ...
    if topo:
        ...
        draw_graph(g1, "Problem 3 - Topological Sort", "problem3_topo.png")
    else:
        report.append("Graph has Cycles:")
        for c in cycles:
            report.append(f"Cycle: {' -> '.join(c)} (length {len(c)-1})")
        draw_graph(g1, "Problem 3 - Cycles", "problem3_cycles.png")
